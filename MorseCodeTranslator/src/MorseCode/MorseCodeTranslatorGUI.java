...
public class MorseCodeTranslatorGUI extends JFrame {
    ...
    // morseCodeArea - translates text into morse code
    ...
    public MorseCodeTranslatorGUI() {
        ...
        // exists program when closing the GUI 
    ...
    private void addGuiComponents() {
        ...
        // change the font size for the label and the font weight
        ...
        // stets teh x, y, position and the width and height dimensions
        ...
        // makes it so that we are litening to key presses whenever we are typing in this text area.
        // textInputArea.addKeyListener(this);

        // simulates padding at 10px in the text area
        textInputArea.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        // makes it so that words wrap to the next line after reaching the end of the next area
        ...
        //         // disable the play button (prevents the sound from getting interruted)
