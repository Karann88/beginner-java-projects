...
public class Hangman extends JFrame implements ActionListener {
    // counts the number of incorrect guesses has been made
    ...
    private void addGuiComponents() {
        ...
        categoryLabel.setBounds(0, hangmanImage.getPreferredSize().height - 28, CommonConstants.FRAME_SIZE.width,
        ...
        if (command.equals("Reset") || command.equals("Restart")) {
            ...
            if (wordChallenge[1].contains(command)) {
                ...
                if (!hiddenWordLabel.getText().contains("*")) {
                    // display result dialog with congratulations label
                    resultLabel.setText("Congratulations! You guessed the word right!");
                    resultDialog.setVisible(true);
                    
                }

            } else {
                // indicates that the user chose the wrong letter
                ...
                if (incorrectGuesses >= 6) {
                    ...
                    resultLabel.setText("You failed to guess the word right, Try again!");
                    resultDialog.setVisible(true);
                }
            }
